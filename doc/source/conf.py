...
latex_documents = [
    ("index", "orgparse.tex", u"orgparse Documentation", u"Takafumi Arakaki", "manual"),
]
...
man_pages = [("index", "orgparse", u"orgparse Documentation", [u"Takafumi Arakaki"], 1)]
